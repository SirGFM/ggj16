...
struct stGfxCtx {
    ...
    /** 32x128 spriteset of the main texture */
    gfmSpriteset *pSset32x128;
    /** 128x32 spriteset of the main texture */
    gfmSpriteset *pSset128x32;
    /** 256x128 spriteset of the main texture */
